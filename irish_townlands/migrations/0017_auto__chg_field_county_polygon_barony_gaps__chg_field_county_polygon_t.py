...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'County.polygon_barony_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_barony_gaps', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'County.polygon_townland_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_townland_gaps', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'County.polygon_civil_parish_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_civil_parish_gaps', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'County.polygon_townland_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_townland_overlaps', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'County.polygon_civil_parish_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_civil_parish_overlaps', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'County.polygon_barony_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_barony_overlaps', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'County.polygon_barony_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_barony_gaps', self.gf('django.db.models.fields.TextField')())

        # Changing field 'County.polygon_townland_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_townland_gaps', self.gf('django.db.models.fields.TextField')())

        # Changing field 'County.polygon_civil_parish_gaps'
        db.alter_column(u'irish_townlands_county', 'polygon_civil_parish_gaps', self.gf('django.db.models.fields.TextField')())

        # Changing field 'County.polygon_townland_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_townland_overlaps', self.gf('django.db.models.fields.TextField')())

        # Changing field 'County.polygon_civil_parish_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_civil_parish_overlaps', self.gf('django.db.models.fields.TextField')())

        # Changing field 'County.polygon_barony_overlaps'
        db.alter_column(u'irish_townlands_county', 'polygon_barony_overlaps', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'irish_townlands.subtownland': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'name_ga': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'osm_id': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'osm_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'osm_uid': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'osm_user': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'db_index': 'True'}),
