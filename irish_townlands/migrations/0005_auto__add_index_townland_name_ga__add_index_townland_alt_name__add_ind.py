...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Townland', fields ['name_ga']
        db.create_index(u'irish_townlands_townland', ['name_ga'])

        # Adding index on 'Townland', fields ['alt_name']
        db.create_index(u'irish_townlands_townland', ['alt_name'])

        # Adding index on 'Barony', fields ['name_ga']
        db.create_index(u'irish_townlands_barony', ['name_ga'])

        # Adding index on 'Barony', fields ['alt_name']
        db.create_index(u'irish_townlands_barony', ['alt_name'])

        # Adding index on 'County', fields ['name_ga']
        db.create_index(u'irish_townlands_county', ['name_ga'])

        # Adding index on 'County', fields ['alt_name']
        db.create_index(u'irish_townlands_county', ['alt_name'])

        # Adding index on 'CivilParish', fields ['name_ga']
        db.create_index(u'irish_townlands_civilparish', ['name_ga'])

        # Adding index on 'CivilParish', fields ['alt_name']
        db.create_index(u'irish_townlands_civilparish', ['alt_name'])


    def backwards(self, orm):
        # Removing index on 'CivilParish', fields ['alt_name']
        db.delete_index(u'irish_townlands_civilparish', ['alt_name'])

        # Removing index on 'CivilParish', fields ['name_ga']
        db.delete_index(u'irish_townlands_civilparish', ['name_ga'])

        # Removing index on 'County', fields ['alt_name']
        db.delete_index(u'irish_townlands_county', ['alt_name'])

        # Removing index on 'County', fields ['name_ga']
        db.delete_index(u'irish_townlands_county', ['name_ga'])

        # Removing index on 'Barony', fields ['alt_name']
        db.delete_index(u'irish_townlands_barony', ['alt_name'])

        # Removing index on 'Barony', fields ['name_ga']
        db.delete_index(u'irish_townlands_barony', ['name_ga'])

        # Removing index on 'Townland', fields ['alt_name']
        db.delete_index(u'irish_townlands_townland', ['alt_name'])

        # Removing index on 'Townland', fields ['name_ga']
        db.delete_index(u'irish_townlands_townland', ['name_ga'])
