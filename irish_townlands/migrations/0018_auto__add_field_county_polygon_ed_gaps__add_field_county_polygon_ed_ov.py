...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'County.polygon_ed_gaps'
        db.add_column(u'irish_townlands_county', 'polygon_ed_gaps',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)

        # Adding field 'County.polygon_ed_overlaps'
        db.add_column(u'irish_townlands_county', 'polygon_ed_overlaps',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'County.polygon_ed_gaps'
        db.delete_column(u'irish_townlands_county', 'polygon_ed_gaps')

        # Deleting field 'County.polygon_ed_overlaps'
        db.delete_column(u'irish_townlands_county', 'polygon_ed_overlaps')
