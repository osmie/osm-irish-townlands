...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CivilParish.name_en'
        db.add_column(u'irish_townlands_civilparish', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Townland.name_en'
        db.add_column(u'irish_townlands_townland', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Barony.name_en'
        db.add_column(u'irish_townlands_barony', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'County.name_en'
        db.add_column(u'irish_townlands_county', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ElectoralDivision.name_en'
        db.add_column(u'irish_townlands_electoraldivision', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CivilParish.name_en'
        db.delete_column(u'irish_townlands_civilparish', 'name_en')

        # Deleting field 'Townland.name_en'
        db.delete_column(u'irish_townlands_townland', 'name_en')

        # Deleting field 'Barony.name_en'
        db.delete_column(u'irish_townlands_barony', 'name_en')

        # Deleting field 'County.name_en'
        db.delete_column(u'irish_townlands_county', 'name_en')

        # Deleting field 'ElectoralDivision.name_en'
        db.delete_column(u'irish_townlands_electoraldivision', 'name_en')
