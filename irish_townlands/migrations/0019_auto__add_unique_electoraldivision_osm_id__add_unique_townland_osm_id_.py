...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ElectoralDivision', fields ['osm_id']
        db.create_unique(u'irish_townlands_electoraldivision', ['osm_id'])

        # Adding unique constraint on 'Townland', fields ['osm_id']
        db.create_unique(u'irish_townlands_townland', ['osm_id'])

        # Adding unique constraint on 'CivilParish', fields ['osm_id']
        db.create_unique(u'irish_townlands_civilparish', ['osm_id'])

        # Adding unique constraint on 'Barony', fields ['osm_id']
        db.create_unique(u'irish_townlands_barony', ['osm_id'])

        # Adding unique constraint on 'County', fields ['osm_id']
        db.create_unique(u'irish_townlands_county', ['osm_id'])

        # Adding unique constraint on 'Subtownland', fields ['osm_id']
        db.create_unique(u'irish_townlands_subtownland', ['osm_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subtownland', fields ['osm_id']
        db.delete_unique(u'irish_townlands_subtownland', ['osm_id'])

        # Removing unique constraint on 'County', fields ['osm_id']
        db.delete_unique(u'irish_townlands_county', ['osm_id'])

        # Removing unique constraint on 'Barony', fields ['osm_id']
        db.delete_unique(u'irish_townlands_barony', ['osm_id'])

        # Removing unique constraint on 'CivilParish', fields ['osm_id']
        db.delete_unique(u'irish_townlands_civilparish', ['osm_id'])

        # Removing unique constraint on 'Townland', fields ['osm_id']
        db.delete_unique(u'irish_townlands_townland', ['osm_id'])

        # Removing unique constraint on 'ElectoralDivision', fields ['osm_id']
        db.delete_unique(u'irish_townlands_electoraldivision', ['osm_id'])
