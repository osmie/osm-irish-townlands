...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field counties on 'CivilParish'
        m2m_table_name = db.shorten_name(u'irish_townlands_civilparish_counties')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('civilparish', models.ForeignKey(orm[u'irish_townlands.civilparish'], null=False)),
            ('county', models.ForeignKey(orm[u'irish_townlands.county'], null=False))
        ))
        db.create_unique(m2m_table_name, ['civilparish_id', 'county_id'])


    def backwards(self, orm):
        # Removing M2M table for field counties on 'CivilParish'
        db.delete_table(db.shorten_name(u'irish_townlands_civilparish_counties'))
