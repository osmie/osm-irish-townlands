...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectoralDivision.name_census1901_tag'
        db.add_column(u'irish_townlands_electoraldivision', 'name_census1901_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ElectoralDivision.name_census1911_tag'
        db.add_column(u'irish_townlands_electoraldivision', 'name_census1911_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Townland.name_census1901_tag'
        db.add_column(u'irish_townlands_townland', 'name_census1901_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Townland.name_census1911_tag'
        db.add_column(u'irish_townlands_townland', 'name_census1911_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'CivilParish.name_census1901_tag'
        db.add_column(u'irish_townlands_civilparish', 'name_census1901_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'CivilParish.name_census1911_tag'
        db.add_column(u'irish_townlands_civilparish', 'name_census1911_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Barony.name_census1901_tag'
        db.add_column(u'irish_townlands_barony', 'name_census1901_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Barony.name_census1911_tag'
        db.add_column(u'irish_townlands_barony', 'name_census1911_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'County.name_census1901_tag'
        db.add_column(u'irish_townlands_county', 'name_census1901_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'County.name_census1911_tag'
        db.add_column(u'irish_townlands_county', 'name_census1911_tag',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectoralDivision.name_census1901_tag'
        db.delete_column(u'irish_townlands_electoraldivision', 'name_census1901_tag')

        # Deleting field 'ElectoralDivision.name_census1911_tag'
        db.delete_column(u'irish_townlands_electoraldivision', 'name_census1911_tag')

        # Deleting field 'Townland.name_census1901_tag'
        db.delete_column(u'irish_townlands_townland', 'name_census1901_tag')

        # Deleting field 'Townland.name_census1911_tag'
        db.delete_column(u'irish_townlands_townland', 'name_census1911_tag')

        # Deleting field 'CivilParish.name_census1901_tag'
        db.delete_column(u'irish_townlands_civilparish', 'name_census1901_tag')

        # Deleting field 'CivilParish.name_census1911_tag'
        db.delete_column(u'irish_townlands_civilparish', 'name_census1911_tag')

        # Deleting field 'Barony.name_census1901_tag'
        db.delete_column(u'irish_townlands_barony', 'name_census1901_tag')

        # Deleting field 'Barony.name_census1911_tag'
        db.delete_column(u'irish_townlands_barony', 'name_census1911_tag')

        # Deleting field 'County.name_census1901_tag'
        db.delete_column(u'irish_townlands_county', 'name_census1901_tag')

        # Deleting field 'County.name_census1911_tag'
        db.delete_column(u'irish_townlands_county', 'name_census1911_tag')
