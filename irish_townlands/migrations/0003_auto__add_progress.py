...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('irish_townlands_progress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('percent', self.gf('django.db.models.fields.FloatField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('irish_townlands', ['Progress'])


    def backwards(self, orm):
        # Deleting model 'Progress'
        db.delete_table('irish_townlands_progress')
