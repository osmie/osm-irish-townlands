...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectoralDivision.ref'
        db.add_column(u'irish_townlands_electoraldivision', 'ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Townland.ref'
        db.add_column(u'irish_townlands_townland', 'ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'CivilParish.ref'
        db.add_column(u'irish_townlands_civilparish', 'ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Barony.ref'
        db.add_column(u'irish_townlands_barony', 'ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'County.ref'
        db.add_column(u'irish_townlands_county', 'ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectoralDivision.ref'
        db.delete_column(u'irish_townlands_electoraldivision', 'ref')

        # Deleting field 'Townland.ref'
        db.delete_column(u'irish_townlands_townland', 'ref')

        # Deleting field 'CivilParish.ref'
        db.delete_column(u'irish_townlands_civilparish', 'ref')

        # Deleting field 'Barony.ref'
        db.delete_column(u'irish_townlands_barony', 'ref')

        # Deleting field 'County.ref'
        db.delete_column(u'irish_townlands_county', 'ref')
