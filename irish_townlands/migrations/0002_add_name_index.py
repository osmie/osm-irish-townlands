...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Townland', fields ['name']
        db.create_index('irish_townlands_townland', ['name'])

        # Adding index on 'County', fields ['name']
        db.create_index('irish_townlands_county', ['name'])

        # Adding index on 'CivilParish', fields ['name']
        db.create_index('irish_townlands_civilparish', ['name'])

        # Adding index on 'Barony', fields ['name']
        db.create_index('irish_townlands_barony', ['name'])


    def backwards(self, orm):
        # Removing index on 'Barony', fields ['name']
        db.delete_index('irish_townlands_barony', ['name'])

        # Removing index on 'CivilParish', fields ['name']
        db.delete_index('irish_townlands_civilparish', ['name'])

        # Removing index on 'County', fields ['name']
        db.delete_index('irish_townlands_county', ['name'])

        # Removing index on 'Townland', fields ['name']
        db.delete_index('irish_townlands_townland', ['name'])
