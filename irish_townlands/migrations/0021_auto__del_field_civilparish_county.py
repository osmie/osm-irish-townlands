...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CivilParish.county'
        db.delete_column(u'irish_townlands_civilparish', 'county_id')


    def backwards(self, orm):
        # Adding field 'CivilParish.county'
        db.add_column(u'irish_townlands_civilparish', 'county',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='civil_parishes', null=True, to=orm['irish_townlands.County']),
                      keep_default=False)
