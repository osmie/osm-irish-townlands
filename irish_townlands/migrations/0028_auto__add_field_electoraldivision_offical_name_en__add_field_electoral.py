...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ElectoralDivision.logainm_ref'
        db.add_column(u'irish_townlands_electoraldivision', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)
        ...
        # Adding field 'Townland.logainm_ref'
        db.add_column(u'irish_townlands_townland', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)
        ...
        # Adding field 'CivilParish.logainm_ref'
        db.add_column(u'irish_townlands_civilparish', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)
        ...
        # Adding field 'Barony.logainm_ref'
        db.add_column(u'irish_townlands_barony', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)
        ...
        # Adding field 'County.logainm_ref'
        db.add_column(u'irish_townlands_county', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ElectoralDivision.logainm_ref'
        db.delete_column(u'irish_townlands_electoraldivision', 'logainm_ref')
        ...
        # Deleting field 'Townland.logainm_ref'
        db.delete_column(u'irish_townlands_townland', 'logainm_ref')
        ...
        # Deleting field 'CivilParish.logainm_ref'
        db.delete_column(u'irish_townlands_civilparish', 'logainm_ref')
        ...
        # Deleting field 'Barony.logainm_ref'
        db.delete_column(u'irish_townlands_barony', 'logainm_ref')
        ...
        # Deleting field 'County.logainm_ref'
        db.delete_column(u'irish_townlands_county', 'logainm_ref')
