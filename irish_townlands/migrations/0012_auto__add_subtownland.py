...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Subtownland'
        db.create_table(u'irish_townlands_subtownland', (
            ...
            ('location_x', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('location_y', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('townland', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subtownlands', to=orm['irish_townlands.Townland'])),
        ))
        db.send_create_signal(u'irish_townlands', ['Subtownland'])


    def backwards(self, orm):
        # Deleting model 'Subtownland'
        db.delete_table(u'irish_townlands_subtownland')
