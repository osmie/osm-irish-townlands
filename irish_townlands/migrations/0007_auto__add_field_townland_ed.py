...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Townland.ed'
        db.add_column(u'irish_townlands_townland', 'ed',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='townlands', null=True, to=orm['irish_townlands.ElectoralDivision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Townland.ed'
        db.delete_column(u'irish_townlands_townland', 'ed_id')
