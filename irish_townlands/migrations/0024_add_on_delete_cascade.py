...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("""
            alter table irish_townlands_civilparish_counties
                drop constraint civilparish_id_refs_id_3db649e1,
                add constraint civilparish_id_refs_id_3db649e1 FOREIGN KEY (civilparish_id) REFERENCES irish_townlands_civilparish(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
        """)
        db.execute("""
            alter table irish_townlands_civilparish_counties
                drop constraint "county_id_refs_id_ba4e6d27",
                add constraint "county_id_refs_id_ba4e6d27" FOREIGN KEY (county_id) REFERENCES irish_townlands_county(id)  ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
        """)
    ...
    def backwards(self, orm):
        db.execute("""
            alter table irish_townlands_civilparish_counties
                drop constraint civilparish_id_refs_id_3db649e1,
                add constraint civilparish_id_refs_id_3db649e1 FOREIGN KEY (civilparish_id) REFERENCES irish_townlands_civilparish(id) DEFERRABLE INITIALLY DEFERRED;
        """)
        db.execute("""
            alter table irish_townlands_civilparish_counties
                drop constraint "county_id_refs_id_ba4e6d27",
                add constraint "county_id_refs_id_ba4e6d27" FOREIGN KEY (county_id) REFERENCES irish_townlands_county(id) DEFERRABLE INITIALLY DEFERRED;
        """)
