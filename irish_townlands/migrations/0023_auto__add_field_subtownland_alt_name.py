...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subtownland.alt_name'
        db.add_column(u'irish_townlands_subtownland', 'alt_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subtownland.alt_name'
        db.delete_column(u'irish_townlands_subtownland', 'alt_name')
