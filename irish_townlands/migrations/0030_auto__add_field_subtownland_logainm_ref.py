...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subtownland.logainm_ref'
        db.add_column(u'irish_townlands_subtownland', 'logainm_ref',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subtownland.logainm_ref'
        db.delete_column(u'irish_townlands_subtownland', 'logainm_ref')
