...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CivilParish.alt_name_ga'
        db.add_column(u'irish_townlands_civilparish', 'alt_name_ga',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Townland.alt_name_ga'
        db.add_column(u'irish_townlands_townland', 'alt_name_ga',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Barony.alt_name_ga'
        db.add_column(u'irish_townlands_barony', 'alt_name_ga',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'County.alt_name_ga'
        db.add_column(u'irish_townlands_county', 'alt_name_ga',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ElectoralDivision.alt_name_ga'
        db.add_column(u'irish_townlands_electoraldivision', 'alt_name_ga',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CivilParish.alt_name_ga'
        db.delete_column(u'irish_townlands_civilparish', 'alt_name_ga')

        # Deleting field 'Townland.alt_name_ga'
        db.delete_column(u'irish_townlands_townland', 'alt_name_ga')

        # Deleting field 'Barony.alt_name_ga'
        db.delete_column(u'irish_townlands_barony', 'alt_name_ga')

        # Deleting field 'County.alt_name_ga'
        db.delete_column(u'irish_townlands_county', 'alt_name_ga')

        # Deleting field 'ElectoralDivision.alt_name_ga'
        db.delete_column(u'irish_townlands_electoraldivision', 'alt_name_ga')
